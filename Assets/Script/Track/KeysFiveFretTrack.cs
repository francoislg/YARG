...
{
    public class KeysFiveFretTrack : AbstractTrack
    {
        ...
        private KeysInputStrategy input;
        ...
        protected override void StartTrack()
        {
            ...
            // Inputs
            input = (KeysInputStrategy) player.inputStrategy;
            input.ResetForSong();
        ...
        {
            // TODO: Doesn't account for when you press off-chord, but :shrug: for now
            return;
            RemoveOldAllowedOverstrums();
